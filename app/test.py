...
class TestDockerapp(unittest.TestCase):
    ...
    # run before each testcase and initializes test version of docker app
    def setUp(self):
        self.app = app.app.test_client()

    # first test case - test save key success and display key/value pair submitted
    ...
    # second test case - same as first
